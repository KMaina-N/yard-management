  ...
  return (
    <div className="w-full bg-gray-100 min-h-screen flex flex-col items-center">
      <h1 className="text-4xl font-extrabold text-gray-800 mb-6 border-b-4 border-blue-500 pb-2">
        Enhanced Yard Map Visualization
      </h1>
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-4xl">
        ...
        {/* Canvas Area */}
        <div className="md:w-2/3 p-2 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl shadow-2xl border-4 border-blue-300 flex items-center justify-center">
          <canvas
            ref={canvasRef}
            id="yardCanvas"
            width={CANVAS_WIDTH}
